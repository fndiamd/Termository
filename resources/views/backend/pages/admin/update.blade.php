  ...
  <form action="{{ url('admin/admin-update', $admins['id_admin']) }}" method="post">
    ...
    <div class="form-row">
      <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control" name="name" id="inputEmail4" placeholder="Username" value="{{ $admins['name'] }}">
      ...
      <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control" name="email" id="inputPassword4" placeholder="Email" value="{{ $admins['email'] }}">
